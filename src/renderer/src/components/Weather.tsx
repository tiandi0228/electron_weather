...
const Weather: React.FC<WeatherProps> = (props) => {
    ...
    useEffect(() => {
        window.electron.ipcRenderer.on('ip', (_event, data) => {
            ...
            <div className="bg-[#31353E] p-3 mt-4 rounded-lg">
                <div className="flex justify-between">
                    <div className="text-gray-400 text-xs">
                        <span className="text-white">{location.select?.city ? location.select?.city : location.location?.city}</span>
                ...
                <div className="py-4 flex items-center">
                    ...
                    <div className="pl-2">
                        ...
                        <div className="text-xs flex items-center pt-1">
                            <div className="border px-1 border-amber-400 mr-1 text-amber-400">
                                AQI 优
                            </div>
